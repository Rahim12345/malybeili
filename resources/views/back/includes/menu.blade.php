                            ...
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <div class="dropend">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('about.create') }}" class="dropdown-item">Haqqımızda</a>
                                            <a href="{{ route('review.index') }}" class="dropdown-item">Rəylər</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <div class="dropend">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('category.index') }}" class="dropdown-item">Kateqoriyalar</a>
